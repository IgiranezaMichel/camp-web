        ...
        <>
            ...
            <div className="row p-2">
                <div className="col-12 mb-2 border-bottom py-3">
                    <div className="display-6">Total Christian {response&&response.responseReady&&response.responseContent!=undefined&&<span className="badge bg-primary">{response.responseContent.total}</span>}</div>
                </div>
          ...
          response.responseContent.content.map((data:any)=>{
            ...
            <section className="row">
                ...
                <div className="card rounded-0 col-md-5 d-flex justify-content-center">
                    ...
                    <div className="mb-2"><Church/> {data.church.church.name}/{data.church.name}</div>
                    <div className="mb-2"><LocationOn/> {data.church.church.location}</div>
                </div>
