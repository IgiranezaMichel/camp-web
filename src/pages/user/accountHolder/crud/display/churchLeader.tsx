...
export const DisplayPastoreAccountHolder=()=>{
        ...
        <>
            ...
            <div className="row p-2">
                <div className="col-12 mb-2 border-bottom py-3">
                    <div className="display-6">Total Pastor {response&&response.responseReady&&response.responseContent!=undefined&&<span className="badge bg-primary">{response.responseContent.total}</span>}</div>
                </div>
