    ...
    <Box sx={{ display: 'flex' }}>
      ...
      <AppBar position="fixed" open={open}>
        <Toolbar>
          ...
          <Typography variant="h6" noWrap className='col-11' component="div">
          <span className='d-flex float-end'>
          <div className="card bg-transparent border-0 mx-2 text-white justify-content-center">Name</div><Avatar/>
          </span>
          </Typography>
        </Toolbar>
      </AppBar>
